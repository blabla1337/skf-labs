...
COPY ./ /home/app/http-response-splitting

# Switching to the new app location:
WORKDIR /home/app/http-response-splitting

RUN chown -R app:app /home/app/http-response-splitting
...
ENTRYPOINT [ "python3", "./http-response-splitting.py" ]
