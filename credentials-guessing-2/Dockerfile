...
COPY ./ /home/app/credentials-guessing-2

# Switching to the new app location:
WORKDIR /home/app/credentials-guessing-2

RUN chown -R app:app /home/app/credentials-guessing-2
...
ENTRYPOINT [ "python3", "./credentials-guessing-2.py" ]
