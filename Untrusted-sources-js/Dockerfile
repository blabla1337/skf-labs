...
COPY ./ /home/app/Untrusted-sources-js

# Switching to the new app location:
WORKDIR /home/app/Untrusted-sources-js

RUN chown -R app:app /home/app/Untrusted-sources-js
...
ENTRYPOINT [ "python3", "./Untrusted-sources.py" ]
