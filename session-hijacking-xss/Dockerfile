...
COPY ./ /home/app/session-hijacking-xss

# Switching to the new app location:
WORKDIR /home/app/session-hijacking-xss

RUN chown -R app:app /home/app/session-hijacking-xss
...
ENTRYPOINT [ "python3", "./Session-hijacking.py" ]
