...
WORKDIR /home/app/client-side-restriction-bypass-2

RUN chown -R app:app /home/app/client-side-restriction-bypass-2
...
ENTRYPOINT [ "python3", "./client-side-restriction-bypass-2.py" ]
