...
RUN apk update --no-cache && apk add python3 python3-dev py3-pip bash git dos2unix imagemagick
...
COPY ./ /home/app/Content-type

# Switching to the new app location:
WORKDIR /home/app/Content-type

RUN chown -R app:app /home/app/Content-type
...
ENTRYPOINT [ "python3", "./Content-type.py" ]
