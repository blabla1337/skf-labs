...
def initialize():
    with sqlite3.connect(DB_FILE_NAME) as connection:
        ...
        cursor.execute("CREATE TABLE Users(UserId INT, username TEXT, hash TEXT, is_admin BOOL)")
        cursor.execute("INSERT INTO Users VALUES(1,'admin','c7f96bc2560a7b9a9e9e52573fda3246', 1)") # ADmiN!@#$SupErSaFE
        cursor.execute("INSERT INTO Users VALUES(2,'john','81dc9bdb52d04dc20036dbd8313ed055', 0)") # 1234
