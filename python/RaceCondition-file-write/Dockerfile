...
COPY ./ /home/app/RaceCondition-file-write

# Switching to the new app location:
WORKDIR /home/app/RaceCondition-file-write

RUN chown -R app:app /home/app/RaceCondition-file-write
