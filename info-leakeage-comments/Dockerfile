...
COPY ./ /home/app/info-leakeage-comments

# Switching to the new app location:
WORKDIR /home/app/info-leakeage-comments

RUN chown -R app:app /home/app/info-leakeage-comments
...
ENTRYPOINT [ "python3", "./info-leakeage-comments.py" ]
