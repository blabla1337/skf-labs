...
```
$ sudo docker pull blabla1337/owasp-skf-lab:external-entity-injection
```

```text
$ sudo docker run -ti -p 127.0.0.1:5000:5000 blabla1337/owasp-skf-lab:external-entity-injection
```
